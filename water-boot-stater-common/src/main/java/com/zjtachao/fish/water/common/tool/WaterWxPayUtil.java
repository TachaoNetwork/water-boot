 ...
 * @since 2.0
 */
public class WaterWxPayUtil {

    /** 日志 **/
    private static final Logger logger = LoggerFactory.getLogger(WaterWxPayUtil.class);
    ...
    public static Map<String, String> xmlToMap(String strXML) {
        try {
            ...
            InputStream stream = new ByteArrayInputStream(strXML.getBytes(UTF8));
    ...
    public static String MD5(String data) throws Exception {
        ...
        byte[] array = md.digest(data.getBytes(UTF8));
        StringBuilder sb = new StringBuilder();
        for (byte item : array) {
